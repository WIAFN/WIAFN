...
public class DroneNPCController : NPCControllerBase
{
    ...
    {
        bool moved = _cm.MoveTowards(position);
    ...
    {
        return new Vector3(transform.position.x - targetPosition.x, transform.position.y - targetPosition.y, transform.position.z - targetPosition.z).sqrMagnitude <= reachCheckSqr;
    }
